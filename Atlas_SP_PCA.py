...
def plot_map(df, x_lim = None, y_lim = None, figsize = (9,12)):
...
def plot_map_fill_multiples_ids_3(df, title, distrito_id, color_ton, x_lim = None, y_lim = None, figsize = (9,12)):
